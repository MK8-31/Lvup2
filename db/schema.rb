...
ActiveRecord::Schema.define(version: 2021_07_03_020806) do
  ...
  create_table "lvpros", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_lvpros_on_user_id"
  end
